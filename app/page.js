    ...
    <>
      ...
      <section className='overflow-hidden whitespace-nowrap container-2 mx-auto mb-32'>
        <div className='slide-animation'>
          ...
          />
          <Review
            content={['단독 서버 성능도 좋고 친절하시고', '서버 끊기는 것도 없어요! 적극 추천해용', '솔직히 딴 호스팅 회사 N#클### 보다 싸고', '성능이 좋아요!! 솔직히 거기는 답도 느린데', '이 서버는 답도 빠르시고 계속 물어봐 주시고', '서비스가 너무 좋은 거 같고 서버에', '신경많이들 써주시는 거 같아용']}
          />
          <Review
