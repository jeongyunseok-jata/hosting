        ...
        <section className='w-full h-[300px] md:h-[500px] bg-contact'>
            <div className='container mx-auto h-full w-full text-center px-4'>
                <div className='contact-center'>
                    <h1 className='text-2xl md:text-5xl text-white font-semibold md:leading-[4rem] pb-3 '>아직 궁금하신점이 있으신가요?</h1>
                    <p className="md:pb-16 text-white font-semibold text-xl">( 오전 10시 ~ 오후 11시 30분 )<br/>( 긴급 서비스 24시간 )</p>
