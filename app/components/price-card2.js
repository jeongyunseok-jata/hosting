...
const price2 = props => (
    <div className='inline w-full h-[570px] sm:w-[394px] mx-4 mb-8 hover:scale-105 duration-300 box-border card-shadow border border-gray-200 relative rounded-md'>
